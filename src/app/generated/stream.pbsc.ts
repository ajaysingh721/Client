...
/**
 * Service client implementation for StreamService
 */
...
export class StreamServiceClient {
  ...
  $raw = {
    /**
     * Server streaming: /StreamService/FetchResponse
     *
    ...
    fetchResponse: (
      ...
      return this.handler.handle({
        ...
        client: this.client,
        path: '/StreamService/FetchResponse',
        requestData,
        requestMetadata,
  ...
  constructor(
    ...
    this.client = clientFactory.createClient('StreamService', settings);
  }
